...
Handlers.add("tokens",
    Handlers.utils.hasMatchingTag("Action", "Tokens"),
    registry.getTokensList
)

Handlers.add("tokensByDeployer",
    Handlers.utils.hasMatchingTag("Action", "Tokens-By-Deployer"),
    registry.getTokensByDeployer
)

Handlers.add("tokenByProcess",
    Handlers.utils.hasMatchingTag("Action", "Token-By-Process"),
    registry.getTokenByProcess
)

Handlers.add("addToken",
    Handlers.utils.hasMatchingTag("Action", "Add-Token"),
    registry.addToken
)

-- Handler to query TokenProcess by InternalId (initial message id)
Handlers.add("queryTokenProcess",
